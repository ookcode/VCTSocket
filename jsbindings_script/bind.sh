...
if [ -z "${CXX_GENERATOR_ROOT+aaa}" ]; then
    CXX_GENERATOR_ROOT="$DIR/../../frameworks/cocos2d-x/tools/bindings-generator"
fi
...
LD_LIBRARY_PATH=${CXX_GENERATOR_ROOT}/libclang $PYTHON_BIN ${CXX_GENERATOR_ROOT}/generator.py SocketLogic.ini -t spidermonkey -s testandroid -o ./../jsbindings
LD_LIBRARY_PATH=${CXX_GENERATOR_ROOT}/libclang $PYTHON_BIN ${CXX_GENERATOR_ROOT}/generator.py Package.ini -t spidermonkey -s testandroid -o ./../jsbindings
